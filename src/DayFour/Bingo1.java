...
public class Bingo1 {
    public static void main(String[] args) {
        ...
        for (int x = 0; x < 99; x++) {
            arrayChecks.vervangDoorNull(x);

            if (!arrayChecks.alEenKolomVolX() && !arrayChecks.alEenRijVolX()) {
    ...
    public void vervangDoorNull(int d) {
        for (int a = 0; a < 99; a++) {
            for (int b = 0; b < 5; b++) {
                for (int c = 0; c < 5; c++) {
    ...
    public boolean alEenRijVolX() {
        for (int a = 0; a < 99; a++) {
            for (int b = 0; b < 5; b++) {
                ...
                if (teller == 5) {
                    System.out.println("Bingo op kaart " + Arrays.deepToString(boards[a]));
                    return true;
                }
            }
        }
