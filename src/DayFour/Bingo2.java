...
public class Bingo2 {
    public static void main(String[] args) {
        Bingo2 arrayChecks = new Bingo2();
        arrayChecks.findwinner();
    }

    public void findwinner() {
        int laatstebord = 123;
        for (int x = 0; x < getrokkenGetallen.length; x++) {

            System.out.println(getrokkenGetallen[x]);
            System.out.println(" ");
            int winnaars = 0;
            ...
            if (winnaars == (boards.length)) {
                System.out.println("Laatste bord gevonden. Laatste getal:");
                System.out.println(getrokkenGetallen[x]);
                System.out.println("Bord:");
                System.out.println(laatstebord + 1);
                printArrays(boards[laatstebord]);
    ...
    public void vervangDoorNull(int d, int[][] board) {

        for (int b = 0; b < 5; b++) {
            for (int c = 0; c < 5; c++) {
                if (board[b][c] == getrokkenGetallen[d]) {
                    board[b][c] = -1;
                }
            }
        }
    ...
    public boolean alEenKolomVolX(int[][] boards) {
    ...
    public void printArrays(int floep[][]) {

        for (int b = 0; b < 5; b++) {
            for (int c = 0; c < 5; c++) {
                System.out.print(floep[b][c]);
                System.out.print(" ");
            }
            System.out.println(" ");
        }
 ...
 /*   public boolean heeftBordBingo() {
        if (alEenRijVolX() || alEenKolomVolX() {
            return true;
        } else return false;
    }
